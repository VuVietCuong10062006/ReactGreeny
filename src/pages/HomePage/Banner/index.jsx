            ...
            <div className="row align-items-center">
              <div className="col-md-6 col-lg-6">
                <div className="banner-content">
                  ...
                  <p>
                    Green có dịch vụ giao hàng tận nơi trên toàn quốc, áp dụng
                    cho khách mua hàng trên website, fanpage và gọi điện
                    thoại,...
                  </p>
                  <div className="banner-btn">
                    <Link to="/shop-page" className="btn btn-inline">
